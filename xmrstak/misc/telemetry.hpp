...
public:
	...
	void push_perf_value(size_t iThd, uint64_t iHashCount, int64_t iTimestamp);
	double calc_telemetry_data(int64_t iLastMilisec, size_t iThread);
