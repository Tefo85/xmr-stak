...
public:
	...
	inline bool get_disconnects(size_t& att, size_t& time) { att = (size_t)connect_attempts; time = (size_t)(disconnect_time != 0 ? get_timestamp() - disconnect_time + 1 : 0); return pool && usr_login[0]; }
...
private:
	...
	std::atomic<int64_t> connect_attempts;
	std::atomic<int64_t> disconnect_time;
